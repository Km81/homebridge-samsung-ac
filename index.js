...
class SamsungAirco {
  constructor(log, config) {
    ...
    this.log.info(`[${this.name}] 플러그인 초기화 중... 버전 1.5.9`);
    ...
    setInterval(() => {
      ...
      this.log.info(`[${this.name}] [HEARTBEAT] 현재 온도 이벤트 재전송: ${temp}°C`);
      this.aircoSamsung.updateCharacteristic(Characteristic.CurrentTemperature, temp);
    }, 15000);
  }
